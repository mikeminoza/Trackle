  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-[#1a1823]/80",
        className
      )}
    >
      {children}
      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-gray-100 dark:bg-[#1a1823]/80"
            />
          )}
