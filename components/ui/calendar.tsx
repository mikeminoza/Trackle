  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative border border-input shadow-sm focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/50 rounded-md",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "flex aspect-square h-8 w-8 items-center justify-center text-sm font-normal leading-none",
